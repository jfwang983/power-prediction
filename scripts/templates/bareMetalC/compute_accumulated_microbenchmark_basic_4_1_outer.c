...
int main() {
  ...
  // Matrix A, elem_t, A_rows, A_cols Setup
	elem_t A[A_rows][A_cols] = { // Matrix A row
		{-56, 75, -61, 53, 71, 33, 92, -24, 111, -49, -46, -44, 127, 48, 6, 82}, // Matrix A row
		{-96, -94, -121, -19, 35, -55, -28, 71, -56, 21, 56, -103, -96, 6, -121, -89}, // Matrix A row
		{-55, 100, 22, 117, -20, -55, -70, 101, -6, -105, -92, 111, 62, -125, -16, 13}, // Matrix A row
		{-65, -105, -13, 123, 3, 27, -14, 121, 25, -16, -124, 81, 0, -84, -117, 99} // Matrix A row
	}; // Matrix A row
