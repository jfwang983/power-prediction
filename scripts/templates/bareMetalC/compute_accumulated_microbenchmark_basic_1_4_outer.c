...
int main() {
  ...
  // Matrix A, elem_t, A_rows, A_cols Setup
	elem_t A[A_rows][A_cols] = { // Matrix A row
		{24, 44, -31, 6, -6, 57, 1, 86, -22, 65, -106, 92, -13, -73, 67, -32} // Matrix A row
	}; // Matrix A row

  // Matrix B, elem_t, B_rows, B_cols Setup
	elem_t B[B_rows][B_cols] = { // Matrix B row
		{111, 29, -19, -124}, // Matrix B row
		{-118, -108, 1, -44}, // Matrix B row
		{-12, 66, 49, 24}, // Matrix B row
		{-39, -115, 90, -43}, // Matrix B row
		{127, 111, -80, -73}, // Matrix B row
		{-71, -104, -71, -3}, // Matrix B row
		{47, -111, -39, 73}, // Matrix B row
		{60, -56, 72, -22}, // Matrix B row
		{-70, -85, -16, -43}, // Matrix B row
		{-95, 45, -55, 27}, // Matrix B row
		{105, 0, 45, -7}, // Matrix B row
		{-5, 58, -38, 34}, // Matrix B row
		{-48, 12, 42, 13}, // Matrix B row
		{-125, -93, 30, -70}, // Matrix B row
		{69, 18, -93, -120}, // Matrix B row
		{-118, -83, -73, -123} // Matrix B row
	}; // Matrix B row
