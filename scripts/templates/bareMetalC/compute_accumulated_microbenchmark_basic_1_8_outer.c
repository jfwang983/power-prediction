...
int main() {
  ...
  // Matrix A, elem_t, A_rows, A_cols Setup
	elem_t A[A_rows][A_cols] = { // Matrix A row
		{-67, 110, -82, 54, 106, 47, 122, -33, -97, -105, -1, 14, 6, -34, -28, -121} // Matrix A row
	}; // Matrix A row

  // Matrix B, elem_t, B_rows, B_cols Setup
	elem_t B[B_rows][B_cols] = { // Matrix B row
		{-107, -60, -28, -121, 84, -120, 69, 20}, // Matrix B row
		{-69, -101, 44, 60, -87, 120, -60, -96}, // Matrix B row
		{4, -66, -25, 67, 31, -42, 78, 57}, // Matrix B row
		{-89, 5, 18, 46, 82, -119, 83, 60}, // Matrix B row
		{107, -18, 30, 45, -88, -15, 47, -82}, // Matrix B row
		{-53, -1, -32, 127, -48, -59, -42, -77}, // Matrix B row
		{-15, -53, -48, -103, 45, 9, -88, -62}, // Matrix B row
		{-14, -25, 93, 4, 79, -8, 90, 52}, // Matrix B row
		{-101, -106, 61, -1, -31, 24, 44, 40}, // Matrix B row
		{40, 14, 71, 125, 7, -17, 83, 100}, // Matrix B row
		{-44, -37, -98, 85, -20, 101, 66, -85}, // Matrix B row
		{-34, 29, 118, 32, 18, 84, 84, 9}, // Matrix B row
		{104, 33, -61, 90, 22, -94, -8, 65}, // Matrix B row
		{-86, 13, 104, -83, -9, -14, 20, 67}, // Matrix B row
		{15, -47, 39, 65, 34, 120, 96, -114}, // Matrix B row
		{125, 42, 30, -81, -20, -41, -69, 1} // Matrix B row
	}; // Matrix B row
