...
int main() {
  ...
  // Matrix A, elem_t, A_rows, A_cols Setup
	elem_t A[A_rows][A_cols] = { // Matrix A row
		{73, 10, 63, -30, 44, 3, 28, -121, -22, 78, 109, -31, 22, -35, 89, 92} // Matrix A row
	}; // Matrix A row

  // Matrix B, elem_t, B_rows, B_cols Setup
	elem_t B[B_rows][B_cols] = { // Matrix B row
		{117, 124, 102, 116}, // Matrix B row
		{103, -87, -99, -62}, // Matrix B row
		{109, 76, -2, 73}, // Matrix B row
		{16, 103, 66, -100}, // Matrix B row
		{11, -91, 75, 106}, // Matrix B row
		{-53, -34, 119, -76}, // Matrix B row
		{-33, 49, 98, -88}, // Matrix B row
		{43, -70, 18, -113}, // Matrix B row
		{-74, 92, 74, 50}, // Matrix B row
		{16, 97, 3, -109}, // Matrix B row
		{-90, 124, -125, 59}, // Matrix B row
		{-127, -94, -20, -23}, // Matrix B row
		{93, 34, -89, -46}, // Matrix B row
		{-22, 36, -126, -99}, // Matrix B row
		{83, -95, -49, -20}, // Matrix B row
		{-114, 122, 67, -93} // Matrix B row
	}; // Matrix B row
