...
int main() {
  ...
  // Matrix A, elem_t, A_rows, A_cols Setup
	elem_t A[A_rows][A_cols] = { // Matrix A row
		{-6, 108, 75, 91}, // Matrix A row
		{-71, -70, 125, -9}, // Matrix A row
		{92, 107, 114, -68}, // Matrix A row
		{-99, 53, -7, -10}, // Matrix A row
		{8, 112, 38, 26}, // Matrix A row
		{-121, -31, -35, -122}, // Matrix A row
		{-115, -112, -102, 3}, // Matrix A row
		{-32, 22, -120, 69}, // Matrix A row
		{-37, -80, 58, -33}, // Matrix A row
		{83, 3, 127, -89}, // Matrix A row
		{18, 20, -8, 77}, // Matrix A row
		{-43, 8, 24, -117}, // Matrix A row
		{-29, -128, 74, 38}, // Matrix A row
		{-79, -102, 17, 96}, // Matrix A row
		{23, 121, -91, -89}, // Matrix A row
		{-106, 84, 43, -72} // Matrix A row
	}; // Matrix A row

  // Matrix B, elem_t, B_rows, B_cols Setup
	elem_t B[B_rows][B_cols] = { // Matrix B row
		{-58, 102, 30, 37, -23, 108, -71, -29, -56, -121, 15, -115, -125, 53, -128, -39}, // Matrix B row
		{23, 72, 74, -17, 87, -10, 14, -30, -41, -103, 97, -1, 75, -42, -98, 84}, // Matrix B row
		{85, -90, 76, 78, -124, -44, -23, 126, 101, -112, 46, -43, 35, 9, -49, 89}, // Matrix B row
		{-84, 95, -80, 115, 61, -65, -28, -105, 48, 19, 45, 19, 23, 75, 111, 42} // Matrix B row
	}; // Matrix B row
