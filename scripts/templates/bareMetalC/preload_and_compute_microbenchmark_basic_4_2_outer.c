...
int main() {
  ...
  // Matrix A, elem_t, A_rows, A_cols Setup
	elem_t A[A_rows][A_cols] = { // Matrix A row
		{92, 48, -111, 124, -10, 87, 51, -56, -99, -121, 13, 44, 32, -50, 124, -64}, // Matrix A row
		{65, 77, -123, -9, 96, 6, -72, 110, -33, -6, 49, -1, -110, 97, 61, 111}, // Matrix A row
		{113, 70, 70, 111, 27, 18, 13, -39, -16, 84, -60, -118, -68, -51, 66, 89}, // Matrix A row
		{-26, -118, 120, -4, -41, -110, -48, -46, 26, -86, 5, -71, 15, -105, 44, -119} // Matrix A row
	}; // Matrix A row
