...
int main() {
  ...
  // Matrix A, elem_t, A_rows, A_cols Setup
	elem_t A[A_rows][A_cols] = { // Matrix A row
		...
		{106, -39}, // Matrix A row
		{-93, -41}, // Matrix A row
		{-101, 125}, // Matrix A row
		{100, 108}, // Matrix A row
		{107, 21}, // Matrix A row
		{-10, -50}, // Matrix A row
		{18, 60}, // Matrix A row
		{-105, 59}, // Matrix A row
  ...
  // Matrix B, elem_t, B_rows, B_cols Setup
	elem_t B[B_rows][B_cols] = { // Matrix B row
		{94, -113, -58, -7, 24, 40, -111, -2, -59, 13, 65, 24, 116, -71, -32, -128}, // Matrix B row
		{2, 23, -38, -14, 120, 51, -45, -53, -31, -36, -19, 95, -15, 77, 49, -68} // Matrix B row
	}; // Matrix B row
