...
int main() {
  ...
  // Matrix A, elem_t, A_rows, A_cols Setup
	elem_t A[A_rows][A_cols] = { // Matrix A row
		{52, 98, 69, 112, 38, 115, 45, 125, -57, 30, 90, 110, -48, 16, -97, 64}, // Matrix A row
		{-51, 26, -24, -35, -75, -6, -44, 92, -36, 77, 117, 39, 91, -28, -80, -110}, // Matrix A row
		{113, -4, 50, -79, 3, -21, -98, 75, 39, 53, -106, 99, -121, -82, 32, -68}, // Matrix A row
		{14, -23, -102, 62, 126, -125, 36, 13, -118, 112, 69, -112, -30, 11, 30, -56} // Matrix A row
	}; // Matrix A row

  // Matrix B, elem_t, B_rows, B_cols Setup
	elem_t B[B_rows][B_cols] = { // Matrix B row
		{-1, -101, -71, 102}, // Matrix B row
		{87, 81, 98, -11}, // Matrix B row
		{-21, -114, 103, -67}, // Matrix B row
		{-54, 50, 85, -128}, // Matrix B row
		{2, 67, -14, 45}, // Matrix B row
		{105, -9, -15, -78}, // Matrix B row
		{95, -109, 29, -114}, // Matrix B row
		{97, -33, -128, -127}, // Matrix B row
		{-3, 108, 124, -18}, // Matrix B row
		{-51, -54, 22, -81}, // Matrix B row
		{-72, 95, 120, 124}, // Matrix B row
		{72, -19, -121, -26}, // Matrix B row
		{-27, -19, 76, -72}, // Matrix B row
		{8, 88, -53, -46}, // Matrix B row
		{-25, 15, -20, -107}, // Matrix B row
		{8, 118, -86, -44} // Matrix B row
	}; // Matrix B row
